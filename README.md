...
## 1. Project Introduction
Welcome to the **Sales Data Analysis** project. This repository focuses on transforming raw transactional data into actionable business insights through rigorous Exploratory Data Analysis (EDA) and subsequent SQL-based advanced analytics.
